...
if (isset($_POST['submit'])) {
  ...
  if ($emailcount == 1) {
    ...
    $body = "Hi, $username. Click here to reset your password
        http://localhost/x/reset_password.php?token=$token";
    $sender_email = "From: it1917@global.org.in";
    echo $body;
  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form method="POST">
        ...
        <input type="submit" name="submit" class="fadeIn fourth" value="Send Email" id="submit" style="margin-top: 10px;">
